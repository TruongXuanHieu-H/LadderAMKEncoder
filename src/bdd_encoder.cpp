...
namespace SINGLELADDERAMK
{
    ...
    void BDDEncoder::encode_and_solve_ladder_amk(int n, int w, int at_most, int initCondLength, int initCond[])
    {
        std::string command = "python3 bdd_ladder_amk.py " + std::to_string(n) + " " + std::to_string(w) + " " + std::to_string(at_most);
