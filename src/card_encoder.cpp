...
namespace SINGLELADDERAMK
{
    ...
    void CardinalityEncoder::encode_amo(vec_int_it it_begin, vec_int_it it_end)
    {
        ...
        std::string command = "python3 card_amo.py " + std::to_string(constr_length) + " " + std::to_string(*it_begin) + " " + std::to_string(first_free_var);
